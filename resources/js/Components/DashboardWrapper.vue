    ...
    <div class="flex flex-col lg:flex-row gap-8">
      ...
      >
        <div class="flex items-center justify-between lg:hidden mb-6 pb-6 border-b border-slate-200">
            <span class="font-extrabold text-lg text-[#1A2B49]">Menu Navigasi</span>
            ...
            <div v-if="role === 'instructor' && hasBlogAccess" class="flex flex-col mb-1 mt-2">
              ...
              >
                <div class="flex items-center gap-3 text-left">
                  ...
                  <span class="leading-tight">Blog Settings</span>
                </div>
            ...
            <div class="flex flex-col mb-1">
              ...
              >
                <div class="flex items-center gap-3 text-left">
                  ...
                  <span class="leading-tight">LMS Settings</span>
                </div>
            ...
            <div class="flex flex-col mb-1">
              ...
              >
                <div class="flex items-center gap-3 text-left">
                  ...
                  <span class="leading-tight">Course Builder Settings</span>
                </div>
