            ...
            >
                ...
                <div class="w-full md:w-[58%] p-8 sm:p-12 md:p-16 flex flex-col justify-center">
                    <div class="flex flex-col items-center text-center mb-8">
                        ...
                        <h2 class="text-3xl font-extrabold text-[#1A2B49] tracking-tight">Verifikasi Login</h2>
                    </div>
                    ...
                    <!-- Info Alert Box -->
                    <div class="bg-[#F9CC6B]/15 border border-[#F9CC6B]/30 rounded-2xl p-5 mb-6 flex flex-col gap-2">
                        <p class="text-slate-600 text-xs font-bold leading-relaxed">
                            Kode OTP keamanan telah dikirim ke alamat email Anda:<br />
                            <span class="text-[#264790] font-extrabold break-all">{{ email }}</span>
                        </p>
                        <p class="text-[#264790] text-[11px] font-extrabold leading-relaxed">
                            Silakan periksa kotak masuk, promosi, atau folder spam Anda.
                        </p>
                    </div>
                    ...
                    <form @submit.prevent="submit" class="flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input 
                              ...
                              maxlength="6"
                              required
                              class="w-full bg-[#F4F7F9] border border-slate-100 rounded-2xl px-5 py-4 text-sm sm:text-base text-slate-700 font-extrabold text-center tracking-[0.5em] focus:outline-none focus:border-[#44A6D9]/50 focus:bg-white transition-all placeholder-slate-300"
                            />
                    ...
                    <div class="flex flex-col gap-4 items-center mt-8">
                        <span class="text-xs font-bold text-slate-400">
                            ...
                            <button 
                              ...
                              class="text-[#44A6D9] hover:underline font-extrabold focus:outline-none"
                            >
                                Kirim Ulang OTP
                            </button>
                        </span>
