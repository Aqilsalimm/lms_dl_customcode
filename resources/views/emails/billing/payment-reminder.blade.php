...
<head>
    ...
    <title>Peringatan Jatuh Tempo - Drastha Learning</title>
    <style>
        ...
        .invoice-box { background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 12px; padding: 24px; margin: 24px 0; border-left: 4px solid #f59e0b; }
        ...
        <table class="main">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>Ini adalah pengingat ramah bahwa tagihan Anda untuk kelas <strong style="color: #264790;">{{ $invoice->subscription->course->title }}</strong> akan jatuh tempo <strong style="color: #f59e0b;">besok</strong>.</p>
                    
                    <p>Mohon segera selesaikan pembayaran Anda agar akses Anda ke materi tidak terputus.</p>
                    ...
                    <p style="margin-top: 30px; font-size: 14px; color: #64748b;">Jika Anda sudah melakukan pembayaran, silakan abaikan email ini. Terima kasih!</p>
                </td>
            </tr>
        </table>
        <div class="footer">
