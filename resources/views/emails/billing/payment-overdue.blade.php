...
<head>
    ...
    <title>Akses Ditangguhkan - Drastha Learning</title>
    <style>
        ...
        <table class="main">
            ...
            <tr>
                <td class="content">
                    ...
                    <p>Kami ingin menginformasikan bahwa akses Anda untuk kelas <strong style="color: #264790;">{{ $invoice->subscription->course->title }}</strong> telah <span class="text-red">ditangguhkan sementara</span>.</p>
                    
                    <p>Hal ini disebabkan karena tagihan bulanan Anda telah melewati tanggal jatuh tempo dan belum kami terima pembayarannya.</p>
                    ...
                    <div class="invoice-box">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td style="padding-bottom: 8px; font-size: 18px; font-weight: 800; text-align: right; color: #ef4444;">Rp {{ number_format($invoice->amount, 0, ',', '.') }}</td>
                            </tr>
                            <tr>
                    ...
                    <p>Jangan khawatir, akses Anda akan <strong>otomatis aktif kembali</strong> segera setelah pembayaran berhasil dilakukan. Klik tombol di bawah ini untuk melihat detail tagihan dan melakukan pembayaran melalui Midtrans.</p>

                    <div style="text-align: center;">
                        <a href="{{ url('/billing/suspended?invoice_id=' . $invoice->id) }}" class="btn">Bayar Sekarang & Aktifkan Akses</a>
                    </div>

                    <p style="margin-top: 30px; font-size: 14px; color: #64748b;">Jika Anda merasa sudah melakukan pembayaran atau memiliki kendala, silakan hubungi tim dukungan kami melalui WhatsApp di 0812-3485-9768.</p>
                </td>
            </tr>
        </table>
        <div class="footer">
